...
gsv<-read.csv("~/Chapter_4/Cerrado/Legacy_2012-2017/GSV_OC_2017_Data+Metadata_vChecked_HP.csv")
names(gsv)
length(unique(gsv$File.name))
unique(gsv$Species)

allcams2017<-read.csv("effort_matrix_gsv_2017.csv")
...
startDate <- as.Date("2017-04-12","%Y-%m-%d") #remove first four days of survey
allcams2017<- allcams2017[-c(1:5), ]
endDate <- as.Date("2017-06-16","%Y-%m-%d") #remove last four days of survey
allcams2017 <- allcams2017[-c(67:70), ]
sort(unique(allcams2017$Date))
